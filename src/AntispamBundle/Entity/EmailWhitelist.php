...
class EmailWhitelist
{
    ...
    public function setWhitelistemail($whitelistemail) { $this->whitelistemail = $whitelistemail; return $this; }
    public function getWhitelistemail() { return $this->whitelistemail; }
